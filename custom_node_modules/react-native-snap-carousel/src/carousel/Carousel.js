...
export default class Carousel extends Component {
    ...
    get slidersPosition () {
        //return this._positions[this._positions.length-1].start;
        return this._positions.map(function(item){return item.start});
    }
    ...
    _onScroll (event) {
        ...
        //console.log('max',this._positions[this._positions.length-1]);
        
        //const scrollConditions = false;
