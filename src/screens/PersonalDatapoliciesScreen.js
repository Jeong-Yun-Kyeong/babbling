      ...
      <Fragment>
        ...
        <ScrollView style={{backgroundColor: 'white', flex: 1}}>
          <View style={{marginTop: 20, marginLeft: 24, marginRight: 24}}>
            ...
            <View>
              <Text style={[styles.bold1, styles.bold2]}>* 회원 관리</Text>
            </View>
            <View style={{marginBottom: 20}}>
              <Text style={[styles.bold1, styles.bold2]}>
            ...
            <View>
              <Text style={[styles.bold1, styles.bold2]}>4. 관련법령정보</Text>
            </View>
            <View style={{marginBottom: 20}}>
              <Text style={[styles.bold1, styles.bold2]}>
            ...
            <View>
              <Text style={[styles.bold1, styles.bold2]}>*기술적 대책</Text>
            </View>
            <View style={{marginBottom: 20}}>
              <Text style={[styles.bold1, styles.bold2]}>
            ...
            <View>
              <Text style={[styles.bold1, styles.bold2]}>*관리적 대책</Text>
            </View>
            <View style={{marginBottom: 20}}>
              <Text style={[styles.bold1, styles.bold2]}>
